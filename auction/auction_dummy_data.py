...
test_account_data = [
   ...
   },
   {
   ...
   },
       {
        ...
        "product_type": "shoe",
        "category": "Jordan 1",
        "product_title": "Jordan 1 Retro High OG SP",
        "secondary_product_title": "Union LA Chicago Shadow",
        "description": "The Jordan 1 Retro High OG SP Union LA Chicago Shadow brings two legendary colorways together in a seamless blend of heritage and innovation. Union LA continues its signature design approach, merging the iconic Chicago red-and-white leather base with the Shadow grey and black ankle collar, creating a striking contrast. The transition between the two sections is accentuated by exposed University Blue stitching, a nod to the craftsmanship behind this unique fusion.",
        "slug": "jordan-1-retro-high-og-sp-union-la-chicago-shadow",
        "buy_now_price": "320",
        "retail_price":"200.00",
        "brand":"Jordan",
        "auction_start_date":"",
        ...
        "reserve_price": "",
        "is_active": True,
        "style_number": "HV8563-600",
        "colorway": "Varsity Red/Black-Sail-Shadow Grey-Muslin",
        "model_year": "2025",
        "release_date": "02/27/2025",
        "size": "9",
        "product_sex": "Male",
        "condition": "new",
        "image": "https://res.cloudinary.com/prblack/image/upload/v1744430267/the_pop_up/snkr5_fyzyrl.png",
        "alternative_text": "Nike Dunk Pro Low SB Low Paris",
        "is_feature": "True"
