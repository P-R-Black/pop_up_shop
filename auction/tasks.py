...
from django.utils.timezone import now
from auction.models import WinnerReservation
from cart.models import PopUpCartItem
from django.core.mail import mail_admins
from pop_up_email.utils import send_auction_winner_email, send_24_hour_reminder_email, send_1_hour_reminder_email
import logging
...
def transition_expired_buy_now_to_auction():
    ...
    for product in products:
        # if buy now expired adn it wasn't purchased, it's ready for auction
